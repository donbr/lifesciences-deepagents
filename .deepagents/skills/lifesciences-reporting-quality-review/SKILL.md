---
name: lifesciences-reporting-quality-review
...
- lifesciences-clinical skill (for target validation reports)
- lifesciences-proteomics skill (for interaction network reports)
...
- **lifesciences-graph-builder**: Fuzzy-to-Fact protocol phases (what to expect in reports)
- **lifesciences-reporting**: Template schemas and evidence grading system
